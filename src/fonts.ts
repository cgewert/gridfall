...
export const PAUSE_OVERLAY_FONT_STYLE = {
  fontFamily: DEFAULT_MENU_FONT,
  fontSize: "32px",
  color: DEFAULT_FONT_COLOR,
  align: "center",
...
export const PAUSE_OVERLAY_FONT_STYLE_ENTRIES = {
  fontFamily: DEFAULT_MENU_FONT,
  fontSize: "24px",
...
export const PAUSE_OVERLAY_FONT_STYLE_ACTIVE_ENTRY = {
  fontFamily: DEFAULT_MENU_FONT,
  fontSize: "36px",
  color: MENU_ENTRY_FONT_COLOR,
  align: "center",
...
export const GUI_LABEL_HOLDBOX_STYLE = {
  fontSize: "16px",
  color: "#ffffff",
  stroke: "#000000",
  fontFamily: DEFAULT_MENU_FONT,
};
export const GUI_COMBO_STYLE = {
  fontFamily: DEFAULT_MENU_FONT,
  fontSize: "20px",
  color: "#ffcc00",
};
...
export const GUI_SCORE_STYLE = {
  fontFamily: DEFAULT_MENU_FONT,
  fontSize: "20px",
  color: "#ffffff",
};
export const GUI_LINES_STYLE = {
  fontSize: "24px",
  color: "#ffffff",
  fontFamily: DEFAULT_MENU_FONT,
};
